    ...
    <div className="w-full h-full flex flex-col gap-6 p-8">
      <div className="flex flex-col gap-4 flex-1">
        ...
        <div className="flex-1 bg-[#E4E3E1] border border-[#d4d3d1] rounded-xl shadow-inner overflow-y-auto">
          {["Organization 1","Organization 2","Organization 3","Organization 4","Organization 5"].map((org) => (
            <div key={org} className="py-2 px-3 text-lg hover:bg-[#A7A7A3] cursor-pointer rounded">
              {org}
            </div>
          ))}
        </div>
